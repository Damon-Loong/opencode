...
export const dict = {
  ...
  "brand.title": "mbmcode | Marca",
  "brand.meta.description": "Diretrizes da marca mbmcode",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca mbmcode.",
