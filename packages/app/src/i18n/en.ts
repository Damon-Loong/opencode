export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by mbmcode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in mbmcode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "mbmcode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in mbmcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in mbmcode.",
  ...
  "prompt.slash.badge.remoteSkill": "remote skill",
  ...
  "dialog.mcp.remoteTool": "remote tool",
  ...
  "dialog.server.description": "Switch which mbmcode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "mbmcode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking mbmcode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking mbmcode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating mbmcode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating mbmcode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update mbmcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update mbmcode",
  "wsl.onboarding.opencodeReadyIn": "mbmcode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "mbmcode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install mbmcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install mbmcode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen mbmcode.",
  ...
  "toast.update.description": "A new version of mbmcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the mbmcode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, mbmcode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "mbmcode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "mbmcode Desktop",
  ...
  "desktop.menu.documentation": "mbmcode Documentation",
  ...
  "desktop.menu.website": "Official website",
  ...
  "settings.desktop.wsl.description": "Run the mbmcode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for mbmcode",
  ...
  "settings.general.row.appearance.description": "Customise how mbmcode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether mbmcode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how mbmcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when mbmcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of mbmcode.",
