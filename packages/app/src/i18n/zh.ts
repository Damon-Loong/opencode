...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 mbmcode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "mbmcode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 mbmcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "mbmcode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 mbmcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 mbmcode 中使用 {{provider}} 模型。",
  ...
  "prompt.slash.badge.remoteSkill": "远程技能",
  ...
  "dialog.server.description": "切换此应用连接的 mbmcode 服务器。",
  ...
  "toast.update.description": "mbmcode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 mbmcode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: mbmcode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "mbmcode 提供免费模型，你可以立即开始使用。",
  ...
  "desktop.menu.toggleSidebar": "显示/隐藏侧边栏",
  "desktop.menu.toggleTerminal": "显示/隐藏终端",
  "desktop.menu.toggleFileTree": "显示/隐藏文件树",
  "desktop.menu.reload": "重新加载",
  "desktop.menu.toggleDeveloperTools": "显示/隐藏开发者工具",
  ...
  "desktop.menu.documentation": "mbmcode 文档",
  "desktop.menu.supportForum": "支持论坛",
  "desktop.menu.exportLogs": "导出日志...",
  "desktop.menu.shareFeedback": "分享反馈",
  "desktop.menu.reportBug": "报告问题",
  "desktop.menu.website": "官网",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 mbmcode 服务器。",
  ...
  "settings.general.row.language.description": "更改 mbmcode 的显示语言",
  "settings.general.row.shell.title": "终端 Shell",
  "settings.general.row.shell.description": "选择在集成终端中使用的 shell",
  ...
  "settings.general.row.appearance.description": "自定义 mbmcode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 mbmcode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 mbmcode 的主题。",
  ...
  "settings.general.row.newLayoutDesigns.description": "启用重新设计的布局、首页、输入框和会话界面",
  "settings.general.row.pinchZoom.title": "捏合缩放",
  "settings.general.row.pinchZoom.description": "允许使用触控板捏合和 Ctrl+滚轮手势缩放",
  ...
  "settings.updates.row.startup.description": "在 mbmcode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 mbmcode。",
