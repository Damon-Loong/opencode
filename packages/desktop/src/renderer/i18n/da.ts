export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af mbmcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af mbmcode er blevet downloadet. Vil du installere den og genstarte?",
