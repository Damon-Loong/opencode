export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju mbmcode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} mbmcode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
