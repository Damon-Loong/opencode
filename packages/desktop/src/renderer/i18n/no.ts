export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av mbmcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av mbmcode er lastet ned. Vil du installere den og starte på nytt?",
