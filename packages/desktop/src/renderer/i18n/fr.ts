export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'mbmcode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'mbmcode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
