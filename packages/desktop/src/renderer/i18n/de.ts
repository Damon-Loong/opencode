export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von mbmcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von mbmcode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
